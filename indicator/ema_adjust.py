...
from backtrader.indicators import MovingAverageBase, ExponentialSmoothing


class ExponentialMovingAverageAdjust(MovingAverageBase):
    '''
    ...
    '''
    alias = ('EMA', 'ExponentialMovingAverageAdjust',)
    lines = ('ema',)
    ...
    def __init__(self):
        ...
        super(ExponentialMovingAverageAdjust, self).__init__()
